...
<ul class="list-group side_left mb-3">
	...
	<a href="home.php?id=<?php echo $_SESSION['id']; ?>" class="card-link text-dark"><i class="fas fa-server"></i> Own Posts <span class="badge badge-info"><?php echo $own; ?></span></a></li>
